 ...
 *
 * Manages customization of Dokan vendor dashboard and product edit form fields.
 */
class VendorDashboard {
     ...
     *
     * Initializes actions to remove vendor dashboard widgets and edit product form fields.
     *
     * @since 1.0.0
     */
     ...
     *
     * Hooks into Dokan dashboard widgets and removes specified widgets based on plugin options.
     *
     * @since 1.0.0
     * @return void
     */
    public function remove_vendor_dashboard_widgets() {
        ...
        // Merge pro hooks if Dokan Pro is active
     ...
     *
     * Hooks into Dokan product edit form sections and removes specified sections based on plugin options.
     *
     * @since 1.0.0
     * @return void
     */
