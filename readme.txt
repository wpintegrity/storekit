...
StoreKit is a helpful toolkit plugin for WooCommerce. Powered by WordPress.
...
3. Navigate to the **`StoreKit`** screen to configure the plugin


== Frequently Asked Questions ==

= Does StoreKit have support with Elementor/Divi? =

No, it does not have any support with Elementor/Divi at this moment.
